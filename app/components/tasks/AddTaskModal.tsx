      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg w-full max-w-md md:max-w-2xl max-h-[calc(100dvh-1.5rem)] overflow-y-auto transform transition-all duration-150 scale-100 opacity-100">
        ...
        <fetcher.Form method="post" className="p-4 sm:p-6 space-y-4 md:space-y-6 md:grid md:grid-cols-2 md:gap-6">
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-300 dark:border-gray-700 md:col-span-2 md:pt-6">
            <button
              type="submit"
              className="flex-1 flex items-center justify-center gap-2 bg-indigo-600 text-white font-semibold px-4 py-2.5 rounded-lg hover:bg-indigo-700 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800"
            >
